...
(function(t) {
    ...
    i.prototype.init = function(o) {
        ...
        var i = /%p\.{0,1}(\d{0,})/,
            ...
            s = /%x\.{0,1}(?:\d{0,})/,
            n = /%y\.{0,1}(?:\d{0,})/;
        return "function" == typeof t && (t = t(o.series.label, o.series.data[o.dataIndex][0]
            , o.series.data[o.dataIndex][1], o))
            , o.series.percent !== void 0 && (t = this.adjustValPrecision(i, t, o.series.percent))
            , o.series.label !== void 0 && (t = t.replace(e, o.series.label))
            , this.isTimeMode("xaxis", o) && this.isXDateFormat(o) &&
        (t = t.replace(s, this.timestampToDate(o.series.data[o.dataIndex][0]
            , this.tooltipOptions.xDateFormat)))
            , this.isTimeMode("yaxis", o) && this.isYDateFormat(o)
        && (t = t.replace(n, this.timestampToDate(o.series.data[o.dataIndex][1]
        ...
        && (t = t.replace(s, Math.floor(o.series.xaxis.tickFormatter(o.series.data[o.dataIndex][0], o.series.xaxis))))
            , o.series.yaxis.tickFormatter !== void 0
        && (t = t.replace(n, Math.floor(o.series.yaxis.tickFormatter(o.series.data[o.dataIndex][1], o.series.yaxis)))), t
