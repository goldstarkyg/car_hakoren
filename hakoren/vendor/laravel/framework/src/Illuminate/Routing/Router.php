...
//        $this->get('login', 'Auth\LoginController@showAdminLoginForm')->name('login');
//        $this->post('login', 'Auth\LoginController@mtclsecuredlogin');
        $this->post('logout', 'Auth\LoginController@logout')->name('logout');

        // Authentication for admin
        $this->get('mtclsecuredlogin', 'Auth\LoginController@showAdminLoginForm')->name('mtclsecuredlogin');
        $this->post('mtclsecuredlogin', 'Auth\LoginController@mtclsecuredlogin');
