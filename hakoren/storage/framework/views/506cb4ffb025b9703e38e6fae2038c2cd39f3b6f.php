...
<?php echo Form::model($customs, array('action' =>'CarClassController@updatecustom',  'class' => 'form-horizontal', 'id'=>'customform', 'role' => 'form', 'method' => 'POST', 'enctype' => 'multipart/form-data')); ?>
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <th class="col-md-2 text-center">
                    日帰り
                    <label class="normalprice"><?php echo e($normal->d1_total); ?>円</label>
                ...
                <th class="col-md-2 text-center">
                    1泊2日
                    <label class="normalprice"><?php echo e($normal->n1d2_total); ?>円</label>
                    <label class="normalmiddle">
                        <span class="glyphicon glyphicon glyphicon-arrow-down"></span>
                    </label>
                    <label class="customprice">
                ...
                <th class="col-md-2 text-center">
                    2泊3日
                    <label class="normalprice"><?php echo e($normal->n2d3_total); ?>円</label>
                    <label class="normalmiddle">
                        <span class="glyphicon glyphicon glyphicon-arrow-down"></span>
                    </label>
                    <label class="customprice">
                ...
                <th class="col-md-2 text-center">
                    3泊4日
                    <label class="normalprice"><?php echo e($normal->n3d4_total); ?></label>
                    <label class="normalmiddle">
                        <span class="glyphicon glyphicon glyphicon-arrow-down"></span>
                    </label>
                    <label class="customprice">
                ...
                <th class="col-md-2 text-center">
                    1日追加
                    <label class="normalprice"><?php echo e($normal->additional_total); ?>円</label>
                    <label class="normalmiddle">
                        <span class="glyphicon glyphicon glyphicon-arrow-down"></span>
                    </label>
                    <label class="customprice">
...
<div class="form-group">
    <div class="pull-right m-r-md">
        <label>
            <?php echo Form::open(array('url' => URL::to('/').'/carbasic/carclass/updatecustom', 'class' => '', 'data-toggle' => 'tooltip', 'title' => 'update')); ?>
...
//    });
    ...
    var custom = {};
    <?php if(session('custom')): ?> custom = <?php echo json_encode(session('custom')) ?>; <?php endif; ?>
    if(custom.title){
    ...
    function changePercent(cond) {
        ...
        var html = percent_val+'% '+percent_attr+" 料金";
        $('#price_title').html(html);
        var d1_day1     = cal('<?php echo e($normal->d1_day1); ?>', percent_val, cond);
        $('#customform input[name="d1_day1"]').val(d1_day1);
        var d1_total    = d1_day1;
        $('#customform input[name="d1_total"]').val(d1_total);
        var n1d2_day1   = cal('<?php echo e($normal->n1d2_day1); ?>', percent_val, cond);
        $('#customform input[name="n1d2_day1"]').val(n1d2_day1);
        var n1d2_day2   = cal('<?php echo e($normal->n1d2_day2); ?>', percent_val, cond);
        $('#customform input[name="n1d2_day2"]').val(n1d2_day2);
        var n1d2_total  =  parseInt('<?php echo e($normal->n1d2_day1); ?>') +  parseInt('<?php echo e($normal->n1d2_day2); ?>');
        n1d2_total      = cal(n1d2_total , percent_val, cond);
        $('#customform input[name="n1d2_total"]').val(n1d2_total);
        var n2d3_day1   = cal('<?php echo e($normal->n2d3_day1); ?>', percent_val, cond);
        $('#customform input[name="n2d3_day1"]').val(n2d3_day1);
        var n2d3_day2   = cal('<?php echo e($normal->n2d3_day2); ?>', percent_val, cond);
        $('#customform input[name="n2d3_day2"]').val(n2d3_day2);
        var n2d3_day3   = cal('<?php echo e($normal->n2d3_day3); ?>', percent_val, cond);
        $('#customform input[name="n2d3_day3"]').val(n2d3_day3);
        var n2d3_total  = parseInt('<?php echo e($normal->n2d3_day1); ?>') + parseInt('<?php echo e($normal->n2d3_day2); ?>') + parseInt('<?php echo e($normal->n2d3_day3); ?>');
        n2d3_total      = cal(n2d3_total , percent_val, cond);
        $('#customform input[name="n2d3_total"]').val(n2d3_total);
        var n3d4_day1   = cal('<?php echo e($normal->n3d4_day1); ?>', percent_val, cond);
        $('#customform input[name="n3d4_day1"]').val(n3d4_day1);
        var n3d4_day2   = cal('<?php echo e($normal->n3d4_day2); ?>', percent_val, cond);
        $('#customform input[name="n3d4_day2"]').val(n3d4_day2);
        var n3d4_day3   = cal('<?php echo e($normal->n3d4_day3); ?>', percent_val, cond);
        $('#customform input[name="n3d4_day3"]').val(n3d4_day3);
        var n3d4_day4   = cal('<?php echo e($normal->n3d4_day4); ?>', percent_val, cond);
        $('#customform input[name="n3d4_day4"]').val(n3d4_day4);
        var n3d4_total  = parseInt('<?php echo e($normal->n3d4_day1); ?>') + parseInt('<?php echo e($normal->n3d4_day2); ?>') + parseInt('<?php echo e($normal->n3d4_day3); ?>') + parseInt('<?php echo e($normal->n3d4_day4); ?>');
        n3d4_total      = cal(n3d4_total , percent_val, cond);
        $('#customform input[name="n3d4_total"]').val(n3d4_total);
        var additional_day  = cal('<?php echo e($normal->additional_day); ?>', percent_val, cond);
	...
	function fetchCarClassCustomData(carClassId, page){
	  ...
	  $.ajax({
			type: "POST",
			dataType: "json",
			url  : "<?php echo url('/fetchCarClassCustomData'); ?>",
			cache: false,
    ...
    $(document).ready(function() {
		...
		fetchCarClassCustomData('<?php echo $carclass->id; ?>', 1);		
...
$(document).ajaxComplete(function() {
    $('#showCarClassCustomData .pagination li a').click(function(e) {
		...
		fetchCarClassCustomData('<?php echo $carclass->id; ?>', page);
    });	
});
</script>