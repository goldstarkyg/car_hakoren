        ...
        <div class="row">
            <div class="panel panel-default">
                ...
                <div style="position: absolute; margin-top: -2.5em;right: 20px;" >
                    <a href="<?php echo e(URL::to('/')); ?>/carbasic/carinsurance/create" class="btn btn-primary btn-xs pull-right" style="margin-left: 1em;">
                        ...
                        <div class="table-responsive users-table">
                            <table class="table table-striped table-condensed data-table" width="100%">
                                ...
                                <?php $__currentLoopData = $insurances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $insurance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr  valign="middle">
                                        <td style="vertical-align: baseline;"><?php echo e(str_pad($insurance->id, 6, '0', STR_PAD_LEFT)); ?></td>
                                        <td class="hidden-xs" style="vertical-align: baseline;"><?php echo e($insurance->abbriviation); ?></td>
                                        <td style="vertical-align: baseline;"><?php echo e($insurance->name); ?></td>
                                        <td style="vertical-align: baseline;">
                                            <label>
                                                <a class="btn btn-sm btn-success" href="<?php echo e(URL::to('carbasic/carinsurance/' . $insurance->id)); ?>" title="詳細">
                                                    <span class="hidden-xs hidden-sm">詳細</span>
                                                </a>
                                            </label>
                                            <label>
                                                <a class="btn btn-sm btn-info " href="<?php echo e(URL::to('/carbasic/carinsurance/' . $insurance->id . '/edit')); ?>" title="編集">
