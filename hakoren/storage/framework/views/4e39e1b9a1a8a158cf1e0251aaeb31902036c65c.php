...
<body>
   <div class="cls-prt">
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $singleRecord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="prtn-cont print-all">
        <div class="top-panel">
            <div class="txt1 ">
                <span>
                    <?php if( $singleRecord->last_name.' '.$singleRecord->first_name == ' '): ?>
                        <td><?php echo $singleRecord->fur_last_name.' '.$singleRecord->fur_first_name; ?> 様</td>
                    <?php else: ?>
                        <td><?php echo $singleRecord->last_name.' '.$singleRecord->first_name; ?> 様</td>
                    <?php endif; ?>
                     [ お客様控え ]</span>
            </div>
            <div class="midl">
                ...
                <div class="vhcl-lft">
                    <table width="100%" border="1" cellspacing="5" cellpadding="5">
                        <tr>
                            ...
                            <td>
                                <?php echo date('Y/m/d', strtotime($singleRecord->departing)); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $singleRecord->class_name; ?> / <?php echo $singleRecord->shortname; ?>
						...
						<tr>
                            ...
                            <td>
                                <div> <span><?php echo e($singleRecord->car_number1); ?> <?php echo e($singleRecord->car_number2); ?></span> <span><?php echo e($singleRecord->car_number3); ?></span> <span><?php echo e($singleRecord->car_number4); ?></span> </div>
                            </td>
                        </tr>
<!--
						<tr>
...
-->
            ...
            <!-- <table width="100%" border="1" cellspacing="5" cellpadding="5"> -->
                ...
                <!-- <tr> -->
                    <!-- <td>出発日</td> -->
                    <!-- <td><?php echo date('Y/m/d', strtotime($singleRecord->departing)); ?></td> -->
                    <!-- <td>&nbsp;</td> -->
                ...
                <!-- <tr> -->
                    <!-- <td>クラス</td> -->
                    <!-- <td><?php echo $singleRecord->class_name; ?></td> -->
                    <!-- <td>&nbsp;</td> -->
                    <!-- <td class="no-border border-rht"></td> -->
                    <!-- <td class="no-border"></td> -->
                <!-- </tr> -->
                ...
                <!-- <tr> -->
                    <!-- <td>顧客の電話番号</td> -->
                    <!-- <td><?php echo e($singleRecord->phone); ?></td> -->
                    <!-- <td>&nbsp;</td> -->
                    <!-- <td class="no-border border-rht"></td> -->
                    <!-- <td class="no-border"></td> -->
                <!-- </tr> -->
            ...
            <div class="print1">
                <div class="option-main">
                    <div class="option-common option-one">
                        <div class="option-bg">
                            <div class="option-left">
                                <img src="<?php echo e(URL::to('/')); ?>/img/print/icon01.png">
                                <h2>油類・液類</h2>
                            </div>
                    ...
                    <div class="option-common option-two">
                        <div class="option-bg">
                            <div class="option-left">
                                <img src="<?php echo e(URL::to('/')); ?>/img/print/icon02.png">
                                <h2>エンジン・ベルト</h2>
                            </div>
                            <div class="option-right">
                                <div class="checkbox">
                    ...
                    <div class="option-common option-three">
                        <div class="option-bg">
                            <div class="option-left">
                                <img src="<?php echo e(URL::to('/')); ?>/img/print/icon03.png">
                                <h2>タイヤ</h2>
                            </div>
                            <div class="option-right">
                                <div class="checkbox">
                    ...
                    <div class="option-common option-four">
                        <div class="option-bg">
                            <div class="option-left">
                                <img src="<?php echo e(URL::to('/')); ?>/img/print/icon04.png">
                                <h2>ブレーキ</h2>
                            </div>
                            <div class="option-right">
                                <div class="checkbox">
                    ...
                    <div class="option-common option-five">
                        <div class="option-bg">
                            <div class="option-left">
                                <img src="<?php echo e(URL::to('/')); ?>/img/print/icon05.png">
                                <h2>ランプ・ワイパー</h2>
                            </div>
                            <div class="option-right">
                                <div class="checkbox">
                    ...
                    <div class="option-common option-six">
                        <div class="option-bg">
                            <div class="option-left">
                                <img src="<?php echo e(URL::to('/')); ?>/img/print/icon06.png">
                                <h2>シートベルト</h2>
                            </div>
                            <div class="option-right">
                                <div class="checkbox">
            ...
            <div class="print2">
                <img src="<?php echo e(URL::to('/')); ?>/img/print/print2.jpg">
            </div>
            <div class="ftr-block">
                <div class="ftr-lft ftr-cm">
                  <div class="ftr-cnt-info">
                   <div class="ftr-cnt">
					...
					<div class="cnt-info">
                        <h2>ハコレンタカー <?php echo e($car_shop_name); ?></h2>
					    <p style="margin: 0 0 5px;">住所 : <?php echo e($car_shop_prefecture); ?><?php echo e($car_shop_city); ?><?php echo e($car_shop_address_1); ?><?php echo e($car_shop_address_2); ?></p>
					    <p style="margin-bottom: 10px;">TEL: <?php echo e($car_shop_phone); ?>　Email: info@hakoren.com</p>
					</div>
                    </div>
                </div>
...
-->
            ...
            <div class="ftr-logo">
                <img src="<?php echo e(URL::to('/')); ?>/img/print/ftr-logo.jpg">
            </div>
        </div>
    </div>
