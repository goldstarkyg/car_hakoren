<?php echo Form::model($shop, array('action' => array('ShopController@updatecomment', $shop->id),  'class' => 'form-horizontal', 'id'=>'editform', 'role' => 'form', 'method' => 'POST', 'enctype' => 'multipart/form-data')); ?>
    ...
    <div class="form-group m-t-sm">
        ...
        <div class="col-sm-10">
            <?php echo Form::textArea('comment', $shop->comment, ['class' => 'form-control', 'required', 'id' => 'comment']); ?>
    ...
    <div class="form-group m-t-sm">
        ...
        <div class="col-sm-10">
            <?php echo Form::textArea('comment_en', $shop->comment_en, ['class' => 'form-control', 'required', 'id' => 'comment_en']); ?>
