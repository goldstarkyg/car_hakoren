<?php $__env->startSection('template_linked_css'); ?>
    <link href="<?php echo e(URL::to('/')); ?>/css/page_carclass_detail.css" rel="stylesheet" type="text/css" xmlns="http://www.w3.org/1999/html"/>
...
<?php $ClassPrice = app('App\Http\DataUtil\ServerPath'); ?>
	...
	<script>
        ...
        dataLayer.push({
            'ecommerce': {
                'detail': {
                    'products': [{
                        'name': '<?php echo e($class->name); ?>',         // Name or ID is required.
                        'id': '<?php echo e($class->id); ?>',
                        'price': '<?php echo e($class->basic_price); ?>',
                        // 'brand': 'エスティマ'
                    }]
                }
            }
        ...
        <?php if($search_cond == '1' && !empty($suggest)): ?>
        dataLayer.push({
            'ecommerce': {
                'currencyCode': 'JPY',
                'impressions': [
                    <?php $__currentLoopData = $suggest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $su): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    {
                        'name'		: '<?php echo e($su->class_name); ?>',  // This has to be generated dynamically
                        'id'		: '<?php echo e($su->class_id); ?>', 		// This has to be generated dynamically
                        'price'		: '<?php echo e($su->all_price); ?>',		// This has to be generated dynamically
                        'list'		: 'Suggested',	// Please name the “list’ as suggested
                        'position'	: '<?php echo e($key + 1); ?>'		// This has to be generated dynamically
                    },
	...
	<div class="page-head hidden-xs">
		...
		<div class="page-title">
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
					<span>レンタカークラス <?php echo e($class->name); ?>の詳細</span><!--<?php echo e(trans('fs.current')); ?>-->
				</li>
			</ul>
		</div>
		<!-- END PAGE TITLE -->
		...
		<div class="container clearfix">
			<div class="col-md-12 bottom-border ">
				<div class="page-header-title">
						<h1>レンタカークラス：<?php echo e($class->name); ?>の詳細</h1>
				</div>
			</div>
		</div>
	</div>
					...
					<div class="box-shadow paddingbox">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<?php echo e($selected_shop); ?>のレンタカークラス&nbsp;<?php echo e($class->name); ?>&nbsp;<br/>対応車種:
									<?php $m = 0; ?>
						...
						<div class="row">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margin-bottom-20 pxs0">
								<div class="row">
									<div class="col-md-12">
										<section class="model_list slider" >
											<?php if(empty($class->thumb_path)): ?>
												<img src="<?php echo e(URL::to('/')); ?>/images/search_default.png" class="img-responsive center-block">
											<?php else: ?>
											<img src="<?php echo e(URL::to('/')); ?>/<?php echo e($class->thumb_path); ?>" class="img-responsive center-block">
											<?php endif; ?>
											<?php $__currentLoopData = $class->thumbnails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $thumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<?php if(!empty($thumb->thumb_path)): ?>
													<div>
														<img src="<?php echo e(URL::to('/')); ?>/<?php echo e($thumb->thumb_path); ?>" class="img-responsive center-block" >
													</div>
												<?php endif; ?>
											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										</section>
								...
								<div class="clearfix" style="margin:5px 0 0 5px;">
									<div class="col-md-12">
										<?php if(empty($class->thumb_path)): ?>
											<img class="cardetail-thumbnail img-responsive center-block" src="<?php echo e(URL::to('/')); ?>/images/search_default.png" width="40" onclick="javascript:$('.model_list').slick('slickGoTo',0)" style="cursor:pointer;">
										<?php else: ?>
											<img class="cardetail-thumbnail img-responsive center-block" src="<?php echo e(URL::to('/')); ?>/<?php echo e($class->thumb_path); ?>" width="40" onclick="javascript:$('.model_list').slick('slickGoTo',0)" style="cursor:pointer;">
										<?php endif; ?>
										<?php $__currentLoopData = $class->thumbnails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $thumb): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<?php if(!empty($thumb->thumb_path)): ?>
												<div>
													<img class="cardetail-thumbnail img-responsive center-block" src="<?php echo e(URL::to('/')); ?>/<?php echo e($thumb->thumb_path); ?>"   width="40" onclick="javascript:$('.model_list').slick('slickGoTo',<?php echo $loop->iteration; ?>)" style="cursor:pointer;">
												</div>
											<?php endif; ?>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</div>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="margin-top: 20px">
								...
								<table id="pricetable">
									...
									<tr>
										<td>当日返却</td>
										<td class="unitprice"><?php echo e(number_format($ClassPrice->getPriceDayNight($class->id,'1','1'))); ?>円</td>
										<td><?php echo e(number_format($ClassPrice->getPriceDayNight($class->id,'1','1'))); ?>円</td>
									</tr>
									<tr>
										<td>1泊2日</td>
										<td class="unitprice"><?php echo e(number_format(round($ClassPrice->getPriceDayNight($class->id,'1','2'))/2)); ?>円</td>
										<td><?php echo e(number_format($ClassPrice->getPriceDayNight($class->id,'1','2'))); ?>円</td>
									</tr>
									<tr>
										<td>1日追加</td>
										<td>--</td>
										<td><?php echo e(number_format($ClassPrice->getPriceDayNight($class->id,'0','0'))); ?>円</td>
									</tr>
								</table>
								<ul class="remarks">
									<li>基本料金に含まれる内容はレンタカー代と消費税です。オプションや免責補償は含まれておりませんがWeb予約時に追加することができます。</li>
									<li>料金は<b><?php echo e(date('Y年n月j日')); ?></b>の料金レートで表示しています。ハイシーズンには料金レートが変動することがありますので、空車検索より期間を設定してご確認ください。</li>
								</ul>
							</div>
						</div>
						<!-- section 1 -->
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 class-detail">
								...
								<ul class="clearfix classdetail-eqlist" >
									<?php $__currentLoopData = $equipments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $eq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php if(!empty($eq->thumbnail)): ?>
											<li><img src="<?php echo e(URL::to('/')); ?>/<?php echo e($eq->thumbnail); ?>" class="img-responsive"></li>
										<?php else: ?>
											<li><img src="<?php echo e(URL::to('/images/carequipment/no-icon.png')); ?>" class="img-responsive"></li>
										<?php endif; ?>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</ul>
							</div>
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 class-detail">
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12">
										<div style="">
											<img src="<?php echo e(URL::to('/')); ?>/img/pages/carbasic/staff-comment.png" class="img-responsive pop-stuff-img">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="popover left show">
											<div class="popover-content">
												<p><?php echo $class->staff_comment; ?></p>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="clearfix margin-bottom-40">
							<div class="col-lg-12  col-md-12 pxs0">
								...
								<div class="p-block search-block bg-darkred carclass_search">
									...
									?>
									<h3><?php echo e($class->name); ?>クラス(<?php echo e($selected_shop); ?>)の見積条件を設定して下さい。</h3>
									<div class="search-block-cont">
										<form method="POST" name="search" id="search" action="<?php echo e(URL::to('/')); ?>/carclass-detail/<?php echo e($class->id); ?>" accept-charset="UTF-8" role="form" class="form-horizontal" enctype="multipart/form-data">
											<?php echo csrf_field(); ?>

											<input type="hidden" id="class_id" name="class_id" value="<?php echo e($class_id); ?>">
											<input type="hidden" name="search_cond" id="search_cond" value="<?php echo e($search_cond); ?>">
											<table class="table search-tbl">
														...
														<div class="row">
															<div class="col-md-4">
																<div id="depart-datepicker" class="input-group date">
																	<input type="text" id="depart_date" name="depart_date" readonly value="<?php echo e($depart_date); ?>" class="form-control datetime-select" required>
															...
															<div class="col-md-4" >
																<select class="chosen-select form-control selectpicker datetime-select" name="depart_time" id="depart_time" required>
																	<?php $__currentLoopData = $hour; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																		<option value="<?php echo e($h); ?>"
																			<?php if($depart_time == $h): ?> selected <?php endif; ?>
																			<?php if(date('H:i') > date($h)): ?> disabled <?php endif; ?>
																		><?php echo e($h); ?> </option>
																	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
																</select>
															</div>
															<div class="col-md-4 hidden">
																<select class="form-control slct-3" name="pickup_id" id="pickup_id">
																	<?php $__currentLoopData = $shops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																		<option value="<?php echo e($shop->id); ?>" <?php if($pickup_id == $shop->id): ?> selected <?php endif; ?>  ><?php echo e($shop->name); ?></option>
																	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
																</select>
															</div>
														</div>
														...
														<div class="row">
															<div class="col-md-4">
																<div id="return-datepicker" class="input-group date">
																	<input type="text" id="return_date" name="return_date" readonly class="form-control datetime-select" value="<?php echo e($return_date); ?>" required>
																	<div class="input-group-addon">
																		<span class="glyphicon glyphicon-th"></span>
																	</div>
																</div>
															...
															<div class="col-md-4" >
																<select class="chosen-select form-control selectpicker datetime-select" name="return_time" id="return_time" required>
																	<?php $__currentLoopData = $hour; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																		<option value="<?php echo e($h); ?>" <?php if($return_time == $h): ?> selected <?php endif; ?>><?php echo e($h); ?> </option>
																	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
																</select>
															</div>
															<div class="col-md-4 hidden">
																<select class="form-control slct-3" name="dropoff_id" id="dropoff_id">
																	<?php $__currentLoopData = $shops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																		<option value="<?php echo e($shop->id); ?>" <?php if($dropoff_id == $shop->id): ?> selected <?php endif; ?> ><?php echo e($shop->name); ?></option>
																	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
																</select>
															</div>
														</div>
												...
												<tr>
													...
													<td>
														<select id="smoking" name="smoking" class="form-control slct-3" style="margin-right: 5px;">
															<?php if($smoke_count > 0 && $non_smoke_count > 0): ?>
															<option value="both" <?php if($smoking == 'both'): ?> selected <?php endif; ?>>どちらでもいい</option>
															<?php endif; ?>
															<?php if($smoke_count > 0): ?>
															<option value="1" <?php if($smoking == '1'): ?> selected <?php endif; ?>>喫煙</option>
															<?php endif; ?>
															<?php if($non_smoke_count > 0): ?>
															<option value="0" <?php if($smoking == '0'): ?> selected <?php endif; ?>>禁煙</option>
															<?php endif; ?>
														</select>
												...
												<tr>
													...
													<td id="passenger_block" style="vertical-align: middle;">
														<?php if($count_mps == 1): ?>
															<b><?php echo e($max_passengers[0]->max_passenger); ?></b>人乗り車両
															<input type="hidden" name="max_passenger" class="car_passenger" value="<?php echo e($max_passengers[0]->max_passenger); ?>">
														<?php elseif($count_mps > 1): ?>
															<?php if($count_notempty > 1): ?>
																...
																<option value="<?php echo e($mp->max_passenger); ?>" <?php if($max_passenger == $mp->max_passenger): ?> selected <?php endif; ?>><?php echo e($mp->max_passenger); ?>人乗り</option>
																<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
																</select>
															<?php elseif($count_notempty == 1): ?>
																<span >
																*ご選択日の在庫は<b><?php echo e($mps[0]->max_passenger); ?></b>名乗りのみとなります。</span>
																<input type="hidden" name="max_passenger" class="car_passenger" value="<?php echo e($mps[0]->max_passenger); ?>">
															<?php else: ?>
												...
												<tr>
													...
													<td>
														<div class="row option_ui" style="margin-left: 5px;">
															<?php $__currentLoopData = $paid_options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $op): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
//																		$op_hidden = 'hidden';
																	...
																	?>
																	<label class="checkbox col-md-4 col-sm-10 col-xs-9 search_option <?php echo e($op_hidden); ?>" style="display: inline;" <?php echo $lbl_id; ?>>
																		<input type="checkbox" name="paid_options[]" class="opt" <?php echo $op_id; ?> value="<?php echo e($op->id); ?>" <?php echo e($checked); ?>>
																		<span><?php echo e($op->name); ?> </span>
																	</label>
																	<label>
																		<?php if($op->google_column_number == 25): ?>
																			*ETC機器は全ての車に標準装備しています。
																		<?php endif; ?>
																	</label>
																	<select name="paid_option_numbers[]" oid="<?php echo e($op->id); ?>" class="opt_num <?php echo e(($op->max_number == 1)? 'hidden':''); ?>">
																		<?php for( $k = 0; $k <= $op->max_number; $k++ ): ?>
																			<option value="<?php echo e($k); ?>" <?php if($k == $pon): ?> selected <?php endif; ?>><?php echo e(($k == 0)? '': $k); ?></option>
																		<?php endfor; ?>
																	</select>
																</div>
															<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
															<?php $__currentLoopData = $free_options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $op): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																...
																?>
																<div class="col-md-12 check_wrap">
																	<label class="checkbox col-xs-6 search_option" style="display: inline;" <?php echo $lbl_id; ?>>
																		<input type="checkbox" name="free_options[]" class="opt <?php echo e($op_class); ?>" <?php echo $op_id; ?> value="<?php echo e($op->id); ?>" <?php echo e($checked); ?>>
																		<span><?php echo e($op->name); ?>(無料)</span>
																	</label>
																	<select name="free_option_numbers[]" oid="<?php echo e($op->id); ?>" class="opt_num <?php echo e(($op->max_number == 1)? 'hidden':''); ?>">
																		<?php for( $k = 0; $k <= $op->max_number; $k++ ): ?>
																			<option value="<?php echo e($k); ?>"><?php echo e(($k == 0)? '': $k); ?></option>
																		<?php endfor; ?>
																	</select>
																</div>
															<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								...
								<?php if(empty($searching) && $search_cond != '0'): ?>
									...
									<div class="p-block result-block bg-darkred">
										<h3 style="font-size:23px; font-weight:500;"><?php echo e($class->name); ?>クラス(<?php echo e($selected_shop); ?>)の検索結果</h3>
										<div class="result-block-cont">
											<div class="row">
												<div class="col-sm-3 hidden-xs text-center" style="padding-right: 0">
													<img src="<?php echo e(URL::to('/')); ?>/images/No-Result.png" class="img-responsive xs-center-block " style="width:75%;float:right;">
												</div>
								...
								<!--loop for search-->
									<?php $__currentLoopData = $top_three; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tcls): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php $cid = $tcls->id; ?>
												...
												<div class="row" style="margin: 0;">
													<div class="col-xs-12">
														<div class="car_title m_T10 m_B20" class_id="<?php echo e($cid); ?>"
															...
															<?php echo e($tcls->class_name); ?>

														</div>
													</div>
													<div class="col-xs-12" style="padding: 0;">
														<div class="col-sm-6 col-xs-12" style="padding: 0 10px;">
															<img src="<?php echo e(URL::to('/').$tcls->thum_path); ?>" class="img-responsive center-block m_Txs60">
															<input type="hidden" class="car_photo" class_id="<?php echo e($cid); ?>" value="<?php echo e($tcls->thum_path); ?>">
															<p class="sml-txt">
																<label class="result_shop">
																	<?php if($tcls->shop_name =="" ): ?>
																		店舗未選択
																	<?php else: ?>
																		<?php echo e($tcls->shop_name); ?>

																	<?php endif; ?>
																</label>
																<label class="result_shop car_category" class_id="<?php echo e($cid); ?>" style="margin-left: 20px;">
																	<?php if($tcls->category_name =="" ): ?>
																		車両カテゴリ未選択
																	<?php else: ?>
																		<?php echo e($tcls->category_name); ?>
    ...
    margin-bottom: 10px;">
																			...
																			<div class="bubble-wrap toltip_wrap" style="width: 100%">
																				...
																				<div class="bubble left afew <?php echo e($leftafew); ?>" class_id="<?php echo e($cid); ?>" style="font-size: 16px">
																					残り在庫<span class="bubble_write car_count"
																							  class_id="<?php echo e($cid); ?>"><?php echo e($tcls->car_count); ?></span>台
																				</div>
																	...
																	<div class="form-group row-bordered-result row">
																		...
																		<label class="pull-right basic_price" class_id="<?php echo e($cid); ?>">
																			<?php echo e(number_format($tcls->price)); ?>円
																		</label>
																		<input type="hidden" class="rent_days" class_id="<?php echo e($cid); ?>"
																			   value="<?php echo e($tcls->night_day); ?>">
																		<input type="hidden" class="price_rent"
																			   class_id="<?php echo e($cid); ?>" value="<?php echo e($tcls->price); ?>">
																	</div>
                                                                    <?php
                                                                    $option_ids = [];
                                                                    $option_names = [];
                                                                    ...
                                                                    ?>
																	<?php if(!empty($tcls->options)): ?>
																		<div class="option-wrapper" class_id="<?php echo e($cid); ?>">
																			<table style="width: 100%">
																				<tbody style="font-size: 13px">
																				<?php $__currentLoopData = $tcls->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $op): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																					<tr class=" row-bordered-result">
																						...
																						<td style="text-align: right">
                                                                                            ...
                                                                                            ?>
																							<span class="opt_cost" oid="<?php echo e($op->id); ?>"
																								  class_id="<?php echo e($cid); ?>"><?php echo e(number_format($oprice)); ?></span>円
																						</td>
																					</tr>
																				<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
																				</tbody>
																		...
																		<div class="form-group row-bordered-result row hidden">
																			<div class="col-xs-6" style="padding: 0">
																				...
																				<select name="insurance"
																					...
																					<option value="<?php echo e($tcls->insurance[1]); ?> selected">
																						免責補償
																					</option>
																					<option value="<?php echo e($tcls->insurance[1]+$tcls->insurance[2]); ?>">
																						ワイド免責補償
																					</option>
																				</select>
																				<input type="hidden" class="insurance_price1"
																					   value="<?php echo e($tcls->insurance_price1); ?>"
																					   class_id="<?php echo e($cid); ?>">
																				<input type="hidden" class="insurance_price2"
																					   value="<?php echo e($tcls->insurance_price2); ?>"
																					   class_id="<?php echo e($cid); ?>">
																			</div>
																	...
																	<div class="form-group row-bordered-result row">
																		<div class="col-xs-12" style="padding: 0">
																			...
																			<input type="hidden" name="car_smoking"
																					class="car_smoking"
																					class_id="<?php echo e($cid); ?>"
																					value="<?php echo e($tcls->smoke); ?>">
																			<label class="pull-right">
																				<?php if($tcls->smoke == '0'): ?> 禁煙 <?php endif; ?>
																				<?php if($tcls->smoke == '1'): ?> 喫煙 <?php endif; ?>
																				<?php if($tcls->smoke == 'both'): ?> どちらでも良い <?php endif; ?>
																			</label>
																		</div>
																	</div>
																	...
																	<div class="form-group row-bordered-result row">
																		...
																		<?php elseif(count($max_passengers) > 1): ?>
																			<div class="col-xs-12" style="padding: 0">
																				...
																				<?php elseif($count_notempty == 1): ?>
																					<span>
                                                                        *現在この車両の在庫は<b><?php echo e($mps[0]->max_passenger); ?></b>名乗りのみとなります。</span>
																					<input type="hidden" name="car_passenger"
																						   class="car_passenger"
																	...
																	<?php if(count($free_options)>0): ?>
																		<div class="form-group row-bordered-result row">
																			<div class="col-xs-12" style="padding: 0">
																				空港送迎
																				<select name="car_pickup" class="car_pickup pull-right" class_id="<?php echo e($cid); ?>">
																					<?php $__currentLoopData = $free_options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																						<option value="<?php echo e($fr->id); ?>"
																								<?php if($fr->id == $shop_search->pickup): ?> selected <?php endif; ?>><?php echo e($fr->name); ?></option>
																					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
																					<option value="" <?php if($shop_search->pickup == ''): ?> selected <?php endif; ?>>
																						不要
																					</option>
																				</select>
																			</div>
																		...
																		<label class="col-sm-7 padding-0" style="color: #b63432">
																			<div style="padding-top: 15px;">
																				<label style="font-weight:bold;font-size: 55px; color:#e60707;/*margin-top: -20px; margin-bottom: -20px;*/" class="total_price" class_id="<?php echo e($cid); ?>">
																					<?php echo e(number_format($tcls->all_price)); ?>

																				</label><label style="font-weight: 300">円</label>
																			</div>
																			<input type="hidden" class="price_all" class_id="<?php echo e($cid); ?>" value="<?php echo e($tcls->all_price); ?>">
																			<div>地域最安値挑戦中！</div>
																		</label>
																	</div>
																</div>
															...
															<div class="text-center">
																<label>
																	<button class="btn bg-grad-red btn_book<?php echo e($cid); ?>" style=" margin-top:10px;padding: 10px 50px 10px 50px"
																			onclick="gotoConfirm(<?php echo e($cid); ?>, '<?php echo e($tcls->class_name); ?>')"
								...
								<?php $__currentLoopData = $searching; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $search): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												...
												<table class="table result-tbl">
													<tr>
														...
														<td>
                                                            ...
                                                            if($class->name == 'W3' || $class->name == 'CW3H') $capacity = 7;
                                                            ?>
															<?php echo e($class->name); ?>　　 <?php echo e($capacity); ?>人乗り
														</td>
													</tr>
													<tr>
														<th><span>車種</span></th>
														<td>
															...
															<?php $__currentLoopData = $search->models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																<?php echo e($model->name); ?> <?php if($cnt > $key+1): ?> / <?php endif; ?>
															<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
														</td>
													</tr>
													<tr>
														<td colspan="2">
															<ul class="clearfix result-carlist" >
																<?php $__currentLoopData = $search->models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																	<?php if(!empty($model->thumb_path)): ?>
																		<li>
																			<img src="<?php echo e(URL::to('/')); ?>/<?php echo e($model->thumb_path); ?>" class="img-responsive">
																		</li>
																	<?php endif; ?>
																<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
															</ul>
													...
													<tr><th><span>ご利用店舗</span></th><td><?php echo e($pickup_name); ?></td></tr>
													<tr>
														<th><span>出発</span></th>
														<td><?php echo e(date('Y年n月j日 G:i', strtotime($depart_date.' '.$depart_time))); ?></td>
													</tr>
													<tr>
														<th><span>返却</span></th>
														<td><?php echo e(date('Y年n月j日 G:i', strtotime($return_date.' '.$return_time))); ?></td>
													</tr>
													<tr>
														<th><span>利用期間</span></th>
														<td><?php if($search->night == 0): ?> 日帰り <?php else: ?> <?php echo e($search->night); ?>泊<?php echo e($search->day); ?>日 <?php endif; ?></td>
													</tr>
												</table>
												<input type="hidden" name="car_count" id="car_count" value="<?php echo e($search->car_count); ?>">
												<p class="bg-carico r-txt">在庫残り<span class="font-red">
														<?php echo e($search->car_count); ?>台</span>です。ご予約はお早めに！</p>
											</div>
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
												<table class="table table-responsive result-detail-tbl">
													...
													<tr>
													<!-- <th>基本料金（<?php echo e($search->night); ?>泊<?php echo e($search->day); ?>日）</th> -->
													<th>
														基本料金 ( <?php if($search->night == 0 && $search->day == 1) { echo "当日返却"; } else { echo $search->night.'泊'.$search->day.'日'; }?> )
													</th>
														<td><?php echo e(number_format($search->price)); ?>円</td>
													</tr>
													<?php if($insurance != '0'): ?>
													...
													<?php endif; ?>
													<?php $__currentLoopData = $search->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $op): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<tr>
															<th><?php echo e($op->abbriviation); ?>

																<?php if($op->google_column_number != 25 && $op->google_column_number != 38): ?>
																(<?php echo e($op->number); ?>個)
																<?php endif; ?>
															</th>
															<td><?php echo e(number_format($op->price)); ?>円</td>
														</tr>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

													<?php if(!empty($free_option_ids)): ?>
													<?php $__currentLoopData = $free_options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $op): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<?php if(in_array($op->id, $free_option_ids)): ?>
													<tr>
														<th>無料オプション</th>
														<td><?php echo e($op->abbriviation); ?></td>
													</tr>
														<?php endif; ?>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
													<?php endif; ?>
													...
													<tr>
														...
														<td class="vta_b">
															<input type="hidden" name="insurance_cost" value="<?php echo e($search->insurance); ?>">
															<span id="insurance_cost">
																<?php echo e(number_format($search->insurance)); ?>
													...
													<input type="hidden" name="all_price" value="<?php echo e($search->price + $search->option_price + $search->insurance); ?>">
													<input type="hidden" name="base_price" value="<?php echo e($search->price); ?>">
													<input type="hidden" name="option_price" value="<?php echo e($search->option_price); ?>">
														...
														<td colspan="2" class="result">
															...
															<div class="pull-right">
																<span id="span_all_price">
																	<?php echo e(number_format($search->price + $search->option_price + $search->insurance)); ?>
												...
												<div class="clearfix bg-white calc-btn hidden">
													<a class="bg-grad-red" onclick="goConfirm(<?php echo e(json_encode($search)); ?>)" >スピード予約に進む</a>
												</div>
											</div>
										</div>
										<div class="row m_T20">
											<div class="col-xs-12 text-center" style="margin-bottom: 20px;">
												<img src="<?php echo e(url('/images/book-now.jpg')); ?>" id="log-booking">
											</div>
								...
								<div class="suggest-block search_cond suggest_wrap">
									<div class="clearfix m_T20">
										<div class="col-lg-offset-1 col-lg-2 col-md-2 col-sm-2 col-xs-3 suggest_stuff">
											<img src="<?php echo e(URL::to('/')); ?>/img/stuff_01.png" class="img-responsive pop-stuff-img">
										</div>
									...
									<div class="suggest-block-cont suggest_item">
										...
										<div class="clearfix m_T20">
											<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
												<img src="<?php echo e(URL::to('/')); ?>/<?php echo e($su->thumb_path); ?>" class="img-responsive center-block">
											</div>
											<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
												<table class="table gradeup-tbl">
													<tr>
														<th colspan="2" style="margin-bottom: 5px; border-top:none!important;" ><span><b class="red-num">
															<?php if($su->all_price > $suggest_price): ?> + <?php endif; ?>
															<?php echo e(number_format($su->all_price-$suggest_price)); ?>円</b>でグレードアップ！</span>
														</th>
													</tr>
													<tr>
														<th><span>ワゴンクラス</span></th>
														<td><?php echo e($su->class_name); ?>　
															<?php if($smoking == 'both'): ?>
																<?php if($su->smoking > 0): ?> 喫煙車 <?php endif; ?>
																<?php if($su->nonsmoking > 0): ?>  禁煙車 <?php endif; ?>
															<?php elseif($smoking == '1'): ?>
																<?php if($su->smoking > 0): ?> 喫煙車 <?php endif; ?>
															<?php elseif($smoking == '0'): ?>
																<?php if($su->nonsmoking > 0): ?>  禁煙車 <?php endif; ?>
															<?php endif; ?>
															<?php echo e($su->passenger->min_passenger); ?>~<?php echo e($su->passenger->max_passenger); ?>人乗り
														</td>
													</tr>
													<tr>
														...
														<td>
															<?php $m = 0; ?>
															<?php $__currentLoopData = $su->models; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																<?php echo e($mo->name); ?> <?php if(count($su->models) > $m+1): ?> / <?php endif; ?>
																<?php $m++; ?>
															<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
														</td>
													</tr>
												...
												<div class="clearfix bg-white calc-btn">
													...
													<a class="bg-grad-red" onclick="gotoSuggestDetail('<?php echo e($su->class_name); ?>', '<?php echo e($su->class_id); ?>', '<?php echo e($su->all_price); ?>', '<?php echo e($key+1); ?>')">グレードアップする</a>
												</div>
											</div>
										</div>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									...
									<table class="table caution2-tbl">
										...
										<tr>
											...
											<div class="clearfix bg-white btn-redboreder">
												<a href="<?php echo e(URL::to('/')); ?>/insurance">免責・補償について</a>
											</div>
											</td>
										</tr>
										<tr>
											<th class="cardetail-tableth">キャンセルについて</th>
											<td>出発日より16日以前であればキャンセル料金はかかりません。<br/>出発日を含めて15日前のお客様のご都合による予約取消はキャンセル料金が発生致しますので、ご了承ください。 キャンセル料金については『<a class="textlink" href="<?php echo e(URL::to('/')); ?>/faq/price" >よくある質問</a>』をご確認ください。</td>
										</tr>
									</table>
								</div>
							</div>
...
<!-- END CONTENT -->
        ...
        <form action="<?php echo e(URL::to('/')); ?>/search-confirm" method="POST" name="booking-submit" id="booking-submit">
            ...
            <input type="hidden" name="data_pickup" id="data_pickup" value="<?php echo e(empty($free_option_ids)? 0 : 1); ?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body text-center">
                    <img src="<?php echo e(URL::to('/')); ?>/images/blank.jpg" style="width: 80%;">
...
<?php $__env->startSection('footer_scripts'); ?>
	...
	<?php if(!empty($searching)): ?>
		...
		$('#insurance_type').change(function () {
			...
			var ins1 = '<?php echo e($search->insurances['ins1']); ?>',
				ins2 = '<?php echo e($search->insurances['ins2']); ?>',
				days = '<?php echo e($search->day); ?>';
			var ans = 0;
        ...
        function check() {
            ...
            var url = '<?php echo e(url('/search-save')); ?>';
            var checked = $('#check-member').prop('checked') ? 1 : 0;
            var pickup = $('.free_pickup:checked').val();
            console.log(pickup);
            if(pickup == undefined) pickup = '';
            var ins1 = parseInt('<?php echo e($search->insurances['ins1']); ?>'),
                ins2 = parseInt('<?php echo e($search->insurances['ins2']); ?>'),
				days = parseInt('<?php echo e($search->day); ?>');
            ...
            var data = {
                ...
                "depart_date" : "<?php echo e($depart_date); ?>",
                "depart_time" : "<?php echo e($depart_time); ?>",
                "return_date" : "<?php echo e($return_date); ?>",
                "return_time" : "<?php echo e($return_time); ?>",
                "depart_shop" : "<?php echo e($pickup_id); ?>",
                "depart_shop_name" : "<?php echo e($pickup_name); ?>",
                "return_shop" : "<?php echo e($dropoff_id); ?>",
                "return_shop_name" : "<?php echo e($dropoff_name); ?>",
                "car_category" : "",
                "passenger" : "<?php echo e($max_passenger); ?>",
                "insurance" : ins_type,
                "insurance_price1" : ins1,
                "insurance_price2" : ins2,
                "smoke" : "<?php echo e($smoking); ?>",
                "class_id" : "<?php echo e($class_id); ?>",
                "class_name" : "<?php echo e($class->name); ?>",
                "class_category" : "",
                "rent_days" : "<?php echo e($search->day - 1); ?>泊<?php echo e($search->day); ?>日",
                "price_rent" : "<?php echo e($search->price); ?>",
                "option_ids" : "<?php echo e($search->selected_option_ids); ?>",
                "option_indexs" : "<?php echo e($search->selected_option_indexes); ?>",
                "option_numbers" : "<?php echo e($search->selected_option_nums); ?>",
                "option_prices" : '<?php echo e($search->selected_option_prices); ?>',
                "pickup" : pickup,
                "member_check" : checked,
                "rent_dates" : '<?php echo e($search->day); ?>'
            };
	...
	<script type="text/javascript">
		var max_passenger = <?php echo e($max_passenger); ?>,
			pickup_id = <?php echo e($pickup_id); ?>;
		...
		$('.datetime-select').change( function () {
			...
			$.ajax({
				url : '<?php echo e(URL::to('/')); ?>/getpassengerlist',
				type: 'post',
				data: {
                    _token		: $('input[name="_token"]').val(),
		...
		//get today
		var today = '<?php echo e($depart_date); ?>';
		var tomday = '<?php echo e($return_date); ?>';
		var tod = new Date();
		...
		function goConfirm(car){
            ...
            $('#data_depart_date').val('<?php echo e($depart_date); ?>');
			$('#data_depart_time').val('<?php echo e($depart_time); ?>');
			$('#data_return_date').val('<?php echo e($return_date); ?>');
			$('#data_return_time').val('<?php echo e($return_time); ?>');
			$('#data_depart_shop').val('<?php echo e($pickup_id); ?>');
			$('#data_depart_shop_name').val('<?php echo e($pickup_name); ?>');
			$('#data_return_shop').val('<?php echo e($dropoff_id); ?>');
			$('#data_return_shop_name').val('<?php echo e($dropoff_name); ?>');
			$('#data_car_category').val('');
			$('#data_passenger').val(car.passenger.min_passenger);
			$('#data_insurance').val('<?php echo e($insurance); ?>');
			$('#data_smoke').val('<?php echo e($smoking); ?>');
			$('#data_class_id').val(car.class_id);
			$('#data_class_name').val(car.class_name);
			$('#data_insurance_price1').val(<?php echo e($class->insurance['ins1']); ?>*car.day);
			$('#data_insurance_price2').val(<?php echo e($class->insurance['ins2']); ?>*car.day);
...
<?php $__env->stopSection(); ?>
<?php $__env->startSection('meta_description', strip_tags($class->staff_comment)); ?>

<?php $__env->startSection('og_tags'); ?>
    <meta property="og:title" content="レンタカークラス：<?php echo e($class->name); ?>の詳細" />
    <meta property="og:url" content="<?php echo e(url('/carclass-detail/'.$class->id)); ?>" />
    <meta property="og:image" content="<?php echo URL::to('/').$class->thumb_path; ?>" />
    <meta property="og:description" content="<?php echo e(strip_tags($class->staff_comment)); ?>" />
