        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-default">
                    ...
                    <?php echo Form::model($template, array('url' => '/mailtemplate/update', 'method' => 'PUT', 'id'=>'editmail', 'enctype'=>'multipart/form-data')); ?>


                    <?php echo csrf_field(); ?>

                    <input type="hidden" id="tempid" name="tempid" value="<?php echo e($template->id); ?>">
                    <div class="panel-body">
                        <div class="form-group has-feedback row <?php echo e($errors->has('mailname') ? ' has-error ' : ''); ?>">
                            <?php echo Form::label('mailname', 'mailname' , array('class' => 'col-md-3 control-label'));; ?>

                            <div class="col-md-9">
                                <div class="input-group">
                                    <?php echo Form::text('mailname', old('mailname'), array('id' => 'mailname', 'readonly'=>'readonly', 'class' => 'form-control', 'placeholder' => 'Please input the mail type')); ?>
                        ...
                        <div class="form-group has-feedback row <?php echo e($errors->has('subject') ? ' has-error ' : ''); ?>">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    <?php echo Form::text('subject', old('subject'), array('id' => 'subject', 'class' => 'form-control', 'placeholder' => 'Please input the subject')); ?>
                        ...
                        <div class="form-group has-feedback row <?php echo e($errors->has('sender') ? ' has-error ' : ''); ?>">
                            <?php echo Form::label('semder', 'sender' , array('class' => 'col-md-3 control-label'));; ?>
                        ...
                        <div class="form-group has-feedback row <?php echo e($errors->has('content') ? ' has-error ' : ''); ?>">
                            <?php echo Form::label('content', 'content' , array('class' => 'col-md-3 control-label'));; ?>

                            <div class="col-md-9">
                                <input type="hidden" id="content" name="content" value="<?php echo e($template->content); ?>">
                                <div class="ibox-content no-padding">
                                    <div class="summernote">
                                        <?php if(old('content') == '' && $template->content == ''): ?>
                                            User name様<br>
                                        <?php else: ?>
                                            <?php if(old('message') == ''): ?>
                    ...
                    <div class="panel-footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <?php echo Form::button('<i class="fa fa-fw fa-save" aria-hidden="true"></i>' . '更新', array('class' => 'btn btn-success btn-block margin-bottom-1 btn-save','type' => 'button', 'data-toggle' => 'modal', 'data-target' => '#confirmSave', 'onclick'=>'clickUpdate()', 'data-title' => Lang::get('modals.edit_user__modal_text_confirm_title'), 'data-message' => 'メールテンプレートの変更を保存しますか？')); ?>
