...
@section('template_title', 'Latest Article In '.$shop->name)
@section('meta_description', 'Latest Article In '.$shop->name)

@section('og_tags')
    <meta property="og:title" content="Latest Articles In {!! $shop->name !!}" />
    <meta property="og:url" content="{{ url('/info/'.$shop->slug) }}" />
    <meta property="og:image" content="" />
    <meta property="og:description" content="View latest articles in {!! $shop->name !!}" />
