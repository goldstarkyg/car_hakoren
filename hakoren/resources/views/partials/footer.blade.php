...
<script src="{{URL::to('/')}}/js/plugins/typedjs/typed.min.js"></script>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-md-offset-4 ">
                        <img src="{{URL::to('/')}}/img/common/{{$util->Tr('logo-lp')}}.png" width="300">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
         <div id="callmodal_first" style="display: block;">
          <div class="col-xs-5 m-top-30">
           <img class="img-responsive" src="{{URL::to('/')}}/img/stuff_02.png" alt="">
          </div>
        ...
        <div class="m-top-20" id="callmodal_third" style="display: block;">
         <img class="img-responsive" src="{{URL::to('/')}}/img/banner_bottom1.png" alt="">
        </div>
      </div>
    </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
         <div id="callmodal_first" style="display: block;">
          <div class="col-xs-4 m-top-30">
           <img class="img-responsive" src="{{URL::to('/')}}/img/banner_top.png" alt="">
          </div>
        ...
        <div class="m-top-20" id="callmodal_third" style="display: block;">
         <img class="img-responsive" src="{{URL::to('/')}}/img/banner_bottom2.png" alt="">
        </div>
      </div>
    </div>
...
@if(!isset($no_sp_tel_icon))
    @if(!Session::has('confirm-submit') || Session::get('confirm-submit') !== true)
    <?php if($time > $time1 && $time < $time2) { ?>
        <div class="text-center btn-fixed visible-xs-block">
          <a href="javascript:void(0);" id="call-button" data-toggle="modal" data-target="#Footer1_Mobile_show_model" style="width:50%;float:left;">
				@if($util->lang() == 'ja')
					<img src="{!! URL::asset('img/call-button.png') !!}"  alt="Call Us" />
				@elseif($util->lang() == 'en')
					<img src="{!! URL::asset('img/call-button_en.png') !!}"  alt="Call Us" />
				@endif
          </a>
          <a href="{{url('/search-car')}}" id="search-button" style="width:50%;float:left;">
				@if($util->lang() == 'ja')
					<img src="{!! URL::asset('img/search-button.png') !!}"  alt="Search Car" />
				@elseif($util->lang() == 'en')
					<img src="{!! URL::asset('img/search-button_en.png') !!}"  alt="Search Car" />
				@endif
          </a>
        </div>
    <?php } ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <ul class = "foo" style="text-align:center;">
                                    <!-- <li><a href="{{URL::to('/')}}/rules">ご利用規約</a></li> -->
							<li><a href="{{URL::to('/')}}/transactions"> @lang('footer.law') </a></li>
							<li><a href="{{URL::to('/')}}/agreement"> @lang('footer.carrental') </a></li>
							<li><a href="{{URL::to('/')}}/contact"> @lang('footer.contactus') </a></li>
							<li><a href="{{URL::to('/')}}/policy"> @lang('footer.policy') </a></li>
						</ul>
                    </div>
                </div>
            </div>
...
@section('footer_scripts')
        ...
        <!--[if lt IE 9] -->
<script src="{{URL::to('/')}}/admin_assets/global/plugins/respond.min.js"></script>
<script src="{{URL::to('/')}}/admin_assets/global/plugins/excanvas.min.js"></script>
<![endif]-->
<!-- BEGIN CORE PLUGINS -->
<script src="{{URL::to('/')}}/admin_assets/global/plugins/bootstrap-hover-dropdown/bootstrap-hover-dropdown.min.js" type="text/javascript"></script>
<script src="{{URL::to('/')}}/admin_assets/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js" type="text/javascript"></script>
<script src="{{URL::to('/')}}/admin_assets/global/plugins/bootstrap-switch/js/bootstrap-switch.min.js" type="text/javascript"></script>
<!-- END CORE PLUGINS -->
...
<script src="{{URL::to('/')}}/admin_assets/global/scripts/app.min.js" type="text/javascript"></script>
<!-- END THEME GLOBAL SCRIPTS -->

<!-- BEGIN THEME LAYOUT SCRIPTS -->
<script src="{{URL::to('/')}}/admin_assets/layouts/layout/scripts/layout.min.js" type="text/javascript"></script>
<script src="{{URL::to('/')}}/admin_assets/layouts/layout/scripts/demo.min.js" type="text/javascript"></script>
<script src="{{URL::to('/')}}/admin_assets/layouts/global/scripts/quick-sidebar.min.js" type="text/javascript"></script>
