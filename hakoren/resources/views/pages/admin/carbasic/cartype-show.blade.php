    ...
    <div>
        <div class="row">
            <div class="panel panel-default">
                <h2>車両タイプの詳細: {{ $cartype->name }}
                    <a href="{{URL::to('/')}}/carbasic/cartype/{{$cartype->id}}/edit" class="btn btn-primary btn-xs pull-right" style="margin-left: 1em;">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="col-sm-9 col-sm-offset-3">
                            <label>
                                <a class="btn btn-info " href="{{ URL::to('/carbasic/cartype/' . $cartype->id . '/edit') }}" title="編集">
