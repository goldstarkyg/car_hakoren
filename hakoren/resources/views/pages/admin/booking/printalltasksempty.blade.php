...
<head>
    ...
    <style type="text/css">
        ...
        * {
        ...
        .option-list ul li {}
.unchecked:before{content:""!important;}
    </style>
</head>
    ...
    <div class="prtn-cont print-all">
        <div class="top-panel">
			...
			<div class="vhcl-block">
                ...
                <div class="vhcl-rht">
                    <table width="100%" border="1" cellspacing="5" cellpadding="5">
                        <tr>
                            <td>
                                車両点検整備者<br/><br/><span style="font-size:20px;"></span>
                            </td>
                            <td>
                                担当者
                            </td>
            ...
            <div class="pas-block">
                <p>【日常点検整備チェック項目】</p>
                <div class="checkbox">
                    <input id="check1" type="checkbox" name="check" value="">
                    <label for="check1" class="unchecked"></label>
                </div>
