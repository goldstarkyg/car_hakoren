...
<head>
    ...
    <style type="text/css">
        ...
        * {
        ...
        .pas-block .checkbox label:before{
            width: 22px;
            height: 22px;
        }
        .pas-block h2{
...
<body>
    <div class="prtn-cont">
        ...
        <div class="top-panel">
            <div class="txt1">
                <span>{!! $data['customer_name'] !!} 様 [ お客様控え ]</span>
            </div>
            <div class="midl">
            ...
            <div class="btm-block">
                <div class="btm-left btm-cm">
                    <p>
                        当社は、道路運送車両法第47条の2 (日常点検整備) 及び第48条 (定期点検整備) に定める点検をし、必要な整備を実施したレンタカーを貸渡するものとします。
                        <br/> 2 借受人又は運転者は、レンタカーの貸渡にあたり、本紙に定める点検表に基づく車体外観及び付属品の検査を行い、レンタカーに整備不良がないこと等を確認するとともにレンタカーが貸渡条件を満たしていることを確認するものとします。
                    </p>
                </div>
                ...
                <div class="vhcl-lft">
                    <table width="100%" border="1" cellspacing="5" cellpadding="5">
                        ...
                        <tr>
                            ...
                            <td>
                                <span>{{$data['car_number1']}}{{$data['car_number2']}}</span> <span>{{$data['car_number3']}}</span> <span>{{$data['car_number4']}}</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
            ...
            <div class="pas-block">
                ...
                <div class="checkbox">
                    ...
                    <label for="check1" checked="checked"></label>
                </div>
            ...
            <div class="ftr-block">
                <div class="ftr-lft ftr-cm">
                    <div class="ftr-cnt-info">
                        <div class="ftr-cnt">
                            <p>
                                本日はハコレンタカーをご利用いただき誠にありがとうございます。
                                <br/>お客様に安全、快適にご利用いただきますよう心を込めてご準備いたしました。
                                <br/>何かお気づきの点がございましたら、ご遠慮なくフロントまでお申し出ください。
                                <br/>これからも、良いクルマと良いサービスをモットーに皆様のご期待に沿えるよう努めて参ります。
                            </p>
                            <span>●貸出に関する連絡先店舗</span>
                        </div>
                        <div class="cnt-info">
                            <h2>ハコレンタカー {{ $data['car_shop_name'] }}</h2>
                            <p style="margin: 0 0 5px;">住所 :{{$data['car_shop_prefecture']}}{{$data['car_shop_city']}}{{$data['car_shop_address_1']}}{{$data['car_shop_address_2']}} </p>
                            <p style="margin-bottom: 18px;">TEL: {{ $data['car_shop_phone'] }}　Email: info@hakoren.com</p>
                ...
                <div class="ftr-rht ftr-cm">
                    ...
                    <div class="ftr-upp">
                        <p>※お客様よりお預かりした車両について
                            <br/>レンタカーをご利用中、お客様の車両（バイク、自転車を含む）をお預かりいたしますが、（原則として1台）、これはサービスの一環として行っています。その為、お預かり中の車両及びその積載品において、不注意によらないで万が一事故や盗難・破損等の損害が発生しましても当社は一切の責任を負えませんので予めご了承下さいませ。
                        </p>
                    </div>
-->
                    <div class="ftr-low">
