...
@section('template_linked_css')
    ...
    <link href="{{URL::to('/')}}/css/plugins/chosen/chosen.css" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="{{ URL::to('/') }}/css/admin_search_plans.css">
    <link rel="stylesheet" href="{{ URL::to('/') }}/css/plugins/dataTables/dataTables.bootstrap.min.css">
    {{--<link href="{{URL::to('/')}}/css/plugins/jquery-ui/jquery-ui.css">--}}
							...
							<div class="box-shadow relative search-panel" style="border: none !important;">
                                <div class="row" style="margin-left: 0px; margin-right: 0px;">
                                    <div class="col-xs-12" style="padding-top:10px;">
                                        {{--{!! csrf_field() !!}--}}
                                        {{--<form method="POST" action="{{URL::to('/')}}/booking/search-plans" accept-charset="UTF-8" role="form" class="form-horizontal" enctype="multipart/form-data" id="search_form">--}}
                                            {!! csrf_field() !!}
                                        <div id="searchform">
                                            <div class="col-sm-7">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-control input-sm" name="depart_shop" id="depart-shop" required>
                                                            ...
                                                            @foreach($shops as $shop)
                                                                <option value="{{$shop->id}}" @if($search->depart_shop == $shop->id) selected @endif>{{$shop->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-control input-sm" name="staff" id="staff" required>
                                                            ...
                                                            @foreach($staffs as $staff)
                                                                ...
                                                                ?>
                                                                @if($staff_name != '')
                                                                <option value="{{$staff->admin_id}}" shop="{{$staff->shop_id}}" @if($search->staff == $staff->admin_id) selected @endif>{{$staff_name}}</option>
                                                                @endif
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="form-group row" style="padding-bottom: 5px;">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-group date col-sm-7 pull-left"  id="depart-datepicker">
                                                            <input type="text" name="depart_date" id="depart_date" class="form-control input-sm datetimepicker" value="{{$search->depart_date}}" readonly required>
                                                        ...
                                                        <div class="col-sm-5 plan_drop" style="padding-right: 0">
                                                            <select class="chosen-select form-control select-md" name="depart_time" id="depart_time" required>
                                                                @foreach($hours as $hour)
                                                                    <option value="{{$hour}}" @if($search->depart_time == $hour) selected @endif>
                                                                        {{$hour}}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="form-group row" style="padding-bottom: 5px">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-group date col-sm-7 pull-left" id="return-datepicker">
                                                            <input type="text" name="return_date" id="return_date" class="form-control input-sm datetimepicker" value="{{$search->return_date}}" readonly required>
                                                            <span class="input-group-addon input-sm"><span class="glyphicon glyphicon-calendar"></span></span>
                                                        </div>
                                                        <div class="col-sm-5 plan_drop" style="padding-right: 0">
                                                            <select class="chosen-select form-control input-sm " name="return_time" id="return_time" required>
                                                                @foreach($hours as $hour)
                                                                    <option value="{{$hour}}" @if($search->return_time == $hour) selected @endif>
                                                                        {{$hour}}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="form-group row hide" style="padding-bottom: 5px">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select class="form-control input-sm" name="return_shop" id="return-shop" >
                                                            <option value="0">選択してください </option>
                                                            @foreach($shops as $shop)
                                                                <option value="{{$shop->id}}" @if($shop->id == $search->return_shop) selected @endif>{{$shop->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group row" style="padding-bottom: 5px">
                                                    ...
                                                    <div class="col-sm-5 hidden">
                                                        ...
                                                        {{--@foreach( $psgtags as $tag)--}}
                                                            {{--<option value="{{ $tag->min_passenger }}" @if($search->passenger == $tag->min_passenger) selected @endif>{{ $tag->name }}</option>--}}
                                                        {{--@endforeach--}}
                                                        </select>
                                                    </div>
                                                    <label class="col-sm-2 control-label" style="font-size:13px;">乗車人数</label>
                                                    <div class="col-xs-3">
                                                        <input class="form-control input-sm" name="real_passenger" id="real_passenger" type="text" style="width: 100%" value="{{ $search->real_passenger }}">
                                                    </div>
                                                </div>
                                                <div class="form-group row" style="padding-bottom: 5px;margin-bottom: 0">
                                                    ...
                                                    <div class="col-xs-10">
                                                        <select name="smoke" id="smoke" class="form-control input-sm">
                                                            <option value="1" @if($search->smoke == 1) selected @endif>喫煙</option>
                                                            <option value="0" @if($search->smoke == 0) selected @endif>禁煙</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group row" style="padding-bottom: 10px;padding-top: 10px;margin-bottom: 0">
                                                    ...
                                                    <div class="col-sm-10" style="padding-top: 5px">
                                                        <label class="pull-left" style="padding-right: 8px;">
                                                            <input type="radio" name="insurance" value="0" @if($search->insurance==0) checked @endif >&nbsp;不要
                                                        </label>
                                                        <label class="pull-left" style="padding-right: 8px;">
                                                            <input type="radio" name="insurance" value="1" @if($search->insurance==1) checked @endif >&nbsp;免責補償
                                                        </label>
                                                        <label class="pull-left">
                                                            <input type="radio" name="insurance" value="2" @if($search->insurance==2) checked @endif >&nbsp;ワイド免責
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="form-group row pickup_object" style="margin-bottom: 30px;">
                                                    ...
                                                    <div class="col-sm-10 pickup_name" style="padding-top:5px">
                                                        <label class="pull-left lbl-btn" >
                                                            <input type="radio" name="pickup" id="pickup2" value="1" @if($search->pickup==1) checked @endif> 要
                                                            <!-- <span class="btn btn-default" style="width: 100%">要</span> -->
                                                        </label>
                                                        <label class="pull-left lbl-btn">
                                                            <input type="radio" name="pickup" id="pickup1" value="0" @if($search->pickup==0) checked @endif> 不要
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <div class="form-group" style="margin-bottom: 0;">
                                                    <input type="hidden" name="option_list" id="option-list" value="{{$search->options}}">
                                                    <input type="hidden" name="option_num_list" id="option-num-list" value="{{$search->option_numbers}}">
                                            ...
                                            <div class="form-group row-bordered row m_B0 hidden">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="hidden" name="car_category" id="car-category" value="{{$car_category}}">
                                                </div>
                                            </div>
                                        </div>
                                        {{--</form>--}}
...
{{--    @include('scripts.admin.booking.all')--}}
    ...
    <script>
        ...
        //initial options
        getOptions();
        filterStaffList({{$search->depart_shop}});
        ...
        function get_user_search_result() {
            $.ajax({
                url : '{{URL::to('/')}}/booking/search-user',
                type:'post',
                data: {
        ...
        function submit_search() {
            ...
            $.ajax({
                url : "{{URL::to('/')}}/booking/search-class",
                data: data,
                type: 'post',
        ...
        function submitBooking() {
            ...
            $.ajax({
                url  : "{{URL::to('/')}}/booking/search-save",
                data : booking_data,
                type : 'post',
