            ...
            <div>
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::open(array('action' => 'EndUsersManagementController@store', 'method' => 'POST', 'role' => 'form', 'class' => 'form-horizontal')) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="hidden" name="shop_ids" id="shop_ids" value="">
