                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="form-group has-feedback row {{ $errors->has('mailname') ? ' has-error ' : '' }}">
                            {!! Form::label('mailname', 'メールタイプ' , array('class' => 'col-md-2 control-label')); !!}
                            <div class="col-md-10">
                                <div class="input-group">
                                    {!! Form::text('mailname', old('mailname'), array('id' => 'mailname', 'class' => 'form-control', 'placeholder' => 'メールタイプを入力してください。 Ex. user_register_book_user')) !!}
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('subject') ? ' has-error ' : '' }}">
                            {!! Form::label('subject', '件名' , array('class' => 'col-md-2 control-label')); !!}
                            <div class="col-md-10">
                                <div class="input-group">
                                    {!! Form::text('subject', old('subject'), array('id' => 'subject', 'class' => 'form-control', 'placeholder' => '件名を入力してください')) !!}
                                    <label class="input-group-addon" for="title"><i class="fa fa-fw fa-pencil }}" aria-hidden="true"></i></label>
                                </div>
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('sender') ? ' has-error ' : '' }}">
                            {!! Form::label('sender', '差出人' , array('class' => 'col-md-2 control-label')); !!}
                            <div class="col-md-10">
                                <div class="input-group">
                        ...
                        <div class="form-group has-feedback row {{ $errors->has('content') ? ' has-error ' : '' }}">
                            {!! Form::label('content', '内容' , array('class' => 'col-md-2 control-label')); !!}
                            <div class="col-md-10">
                    ...
                    <div class="panel-footer">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-sm-offset-3">
                                {!! Form::button('<i class="fa fa-fw fa-save" aria-hidden="true"></i>' . '変更を保存する', array('class' => 'btn btn-success btn-block margin-bottom-1 btn-save','type' => 'button', 'data-toggle' => 'modal', 'data-target' => '#confirmSave', 'onclick'=>'clickUpdate()', 'data-title' => Lang::get('modals.edit_user__modal_text_confirm_title'), 'data-message' => 'メールテンプレートの変更を保存しますか？')) !!}
                            </div>
                        </div>
                    </div>
