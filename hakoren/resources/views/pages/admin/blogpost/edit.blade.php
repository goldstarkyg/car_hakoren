    ...
    <div>
        <div class="row">
            <div class="panel panel-default">
                <h2>ブログの編集: {{ $blogpost->name }}
                    <a href="{{URL::to('/')}}/adminblog/blogposts/{{$blogpost->id}}" class="btn btn-primary btn-xs pull-right" style="margin-left: 1em;">
        ...
        <div class="row">
            <div class="panel with-nav-tabs panel-default shadow-box">
                 ...
                 {!! Form::model($blogpost, array('method' => 'PATCH', 'files' => true,'action' => array('BlogPostsController@update', $blogpost->id),  'class' => 'form-horizontal', 'id'=>'editform')) !!}
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr class="{{ $errors->has('shop_id') ? ' has-error ' : '' }}" >
                                ...
                                <td class="col-md-9">                                  
                                    {!! Form::select('shop_id',[''=>'Please Select']+$shop,  null,
                                                array('id' => 'shop_id',
                                                'class' => 'form-control')) !!}
                            ...
                            <tr class="{{ $errors->has('post_tag_id') ? ' has-error ' : '' }}" >
                                ...
                                <td class="col-md-9">                                  
                                    {!! Form::select('post_tag_id',[''=>'Please Select']+$posttagdata,  NULL,
                            ...
                            <tr class="{{ $errors->has('title_en') ? ' has-error ' : '' }}" >
                                ...
                                <td class="col-md-9">
                                    {!! Form::text('title_en', NULL,
                                                array('id' => 'title_en',
                                                'class' => 'form-control',
                                                'placeholder' => 'Blog Post Title(enn)')) !!}
            ...
            <label>
                 ...
                 {!! Form::open(['method' => 'DELETE', 'url' =>URL::to('/').'/adminblog/blogposts/' . $blogpost->id, 'data-toggle' => 'tooltip', 'title' => 'Delete'])!!}
                ...
                {!! Form::button('<i class="fa fa-trash-o fa-fw" aria-hidden="true"></i>
                    ...
                    array('class' => 'btn btn-danger',
                        ...
                        'data-title' => 'ブログを削除',
                        'data-message' => 'このブログを本当に削除しますか？この操作を取り消すことはできません。')) !!}
                {!! Form::close() !!}
            </label>
                    </td>
                 </tr>                             
