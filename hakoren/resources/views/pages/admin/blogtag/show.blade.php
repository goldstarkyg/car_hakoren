    ...
    <div>
        <div class="row">
            <div class="panel panel-default">
                <h2>タグの詳細: {{ $blogtag->title }}
                    <a href="{{URL::to('/')}}/adminblog/blogtags/{{$blogtag->id}}/edit" class="btn btn-primary btn-xs pull-right" style="margin-left: 1em;">
            ...
            <div class="panel panel-default shadow-box">
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">タグのタイトル</label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">I人気のタグ？</label>
                        <div class="col-sm-9 m-t-xs">
                            {!! $blogtag->is_popular_tag?'Yes':'No' !!}
                        </div>
                    </div>                    
