    ...
    <div>
        <div class="row">
            <div class="panel panel-default">
                <h2 style="display: inline-block;margin-right:30px;">車両修理一覧</h2>
                <form class="form-inline" method="get" name="search" id="search" action="{{URL::to('/')}}/carrepair">
                    {!! csrf_field() !!}
                    <div class="form-group">
                        {{--<label for="email">店舗&emsp;</label>--}}
                        <select name="search_shop" id="search_shop" class="form-control" onchange="searchRepair()">
