        ...
        <div class="row">
            <div class="panel panel-default">
                ...
                <div style="position: absolute; margin-top: -2.5em;right: 20px;" >
                    <a href="{{URL::to('/')}}/adminblog/posttags/create" class="btn btn-primary btn-xs pull-right" style="margin-left: 1em;">
                                ...
                                @foreach($tagdata as $tag)
                                    <tr  valign="middle">
                                        ...
                                        <td style="vertical-align: middle;">
                                            <label>
                                                <a class="btn btn-sm btn-success" href="{{ URL::to('adminblog/posttags/' . $tag->id) }}" title="詳細">
                                                    <span class="hidden-xs hidden-sm">詳細</span>
                                                </a>
                                            </label>
                                            <label>
                                                <a class="btn btn-sm btn-info " href="{{ URL::to('/adminblog/posttags/' . $tag->id . '/edit') }}" title="編集">
